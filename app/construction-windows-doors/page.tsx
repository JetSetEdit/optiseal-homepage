    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-6 flex-1 w-full">
        ...
        <section className="mb-10 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Construction Sealing Solutions</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-4">
            Explore our range of construction sealing solutions. Select a category below to learn more about each solution.
          </p>
        </section>
        ...
        <section className="mb-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Card key={cat.name} className="hover:shadow-xl transition-shadow duration-200">
                <CardHeader>
                  <CardTitle>{cat.name}</CardTitle>
                </CardHeader>
                <CardContent>
                  <Button asChild className="w-full">
                    <a href={cat.href}>Explore</a>
                  </Button>
                </CardContent>
              </Card>
            ))}
