      ...
      <div className="container mx-auto px-4 py-6 flex-1 w-full">
        ...
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/construction-decking-timber">Construction</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Decking & Timber</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <section className="mb-10 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Construction: Decking & Timber</h1>
